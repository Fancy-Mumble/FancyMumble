...
use windows::Win32::Graphics::Direct3D12::{
    ...
    D3D12_RESOURCE_STATE_COPY_DEST, D3D12_RESOURCE_STATE_VIDEO_PROCESS_READ,
    D3D12_RESOURCE_STATE_VIDEO_PROCESS_WRITE, D3D12_RESOURCE_STATES,
    D3D12_RESOURCE_TRANSITION_BARRIER, D3D12_TEXTURE_LAYOUT_UNKNOWN, D3D12CreateDevice,
    ID3D12CommandAllocator, ID3D12CommandQueue, ID3D12Device, ID3D12Fence, ID3D12Resource,
};
...
use windows::Win32::Media::MediaFoundation::{
    ...
    D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC, D3D12_VIDEO_SIZE_RANGE, ID3D12VideoDevice,
