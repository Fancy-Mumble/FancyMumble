...
import WindowTitleBar, { type ChromePlatform } from "./components/client/WindowTitleBar";
...
export function DesignSheet({ onBackToClient }: { onBackToClient?: () => void }) {
  ...
  return (
    <div className={styles.root} data-testid="aurora-ui-root">
...
export default function AuroraApp() {
  ...
  return <AuroraClientApp onOpenDesignSheet={() => setShowDesignSheet(true)} />;
}
