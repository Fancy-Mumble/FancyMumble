...
export default function FoundationSection() {
  return (
    <Section
      ...
      title="The visual grammar"
      description="Color, type, elevation, shape, icons, spacing, and identity primitives form the shared baseline."
    >
      <div className={layout.specimenGrid}>
        <Specimen title="Color tokens" meta="Semantic palette" wide>
          <div className={foundation.swatches}>
            {[
              ["Ink", "#0B0E13", foundation.ink],
              ["Canvas", "#12171E", foundation.canvas],
              ["Cloud", "#F3F5F7", foundation.cloud],
              ["Signal", "#69B7E8", foundation.signal],
              ["Slate", "#718096", foundation.iris],
              ["Coral", "#E4776D", foundation.coral],
            ].map(([name, hex, className]) => (
              <div key={name} className={foundation.swatch}>
        ...
        <Specimen title="Typography" meta="Display / body / mono" wide>
          <div className={foundation.typeScale}>
            ...
            <div>
              <span>Body</span>
              <p>
                Designed to remain readable in dense workspaces, long conversations, and peripheral controls.
              </p>
            </div>
        ...
        <Specimen title="Avatars & presence" meta="User identity">
          <div className={identity.avatarRow}>
            ...
            <Avatar label="AK" />
            <Avatar label="SR" online />
            <span className={identity.avatarGroup}>
              {avatars.map((value) => (
                <Avatar key={value} label={value} />
              ))}
              <b>+8</b>
            </span>
          </div>
        ...
        <Specimen title="Chips & badges" meta="Metadata">
          <div className={layout.wrapRow}>
            ...
            <span className={identity.successChip}>
              <Check size={12} /> verified
            </span>
            <span className={identity.roleChip}>
