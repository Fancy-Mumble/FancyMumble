...
import { ArrowLeftIcon, DownloadIcon, StarIcon, ArrowUpRightIcon, GlobeIcon, CheckIcon } from "../../icons";
...
import { isPluginAdminSupported } from "../admin";
    ...
    <div className={styles.pageScroll}>
      <div className={styles.page}>
        <div className={styles.toolbar}>
          <button type="button" className={styles.backBtn} onClick={() => navigate("/admin?tab=marketplace")}>
        ...
        {plugin && (
          <>
              ...
              <div className={styles.headerBody}>
                ...
                <div className={styles.headerMain}>
                  <h1 className={styles.title}>
                    {plugin.name}
                    {plugin.official && (
                      <span className={styles.officialBadge}>{t("marketplace.official")}</span>
                    )}
                  </h1>
            ...
            {plugin.tags && plugin.tags.length > 0 && (
              <section className={styles.section}>
                <h2 className={styles.sectionTitle}>{t("marketplace.tags", { defaultValue: "Tags" })}</h2>
                          ...
                          {v.min_fancy_server_version && (
                            <span>
                              ...
                              {t("marketplace.minFancyServer", {
                                ...
                                version: v.min_fancy_server_version,
                              })}
                            </span>
                          )}
                          {v.abi_version != null && (
                ...
                <div className={styles.metaRow}>
                  {plugin.license ? (
                    <span className={styles.licenseNote}>
                      {t("marketplace.license", { defaultValue: "License" })}:{" "}
