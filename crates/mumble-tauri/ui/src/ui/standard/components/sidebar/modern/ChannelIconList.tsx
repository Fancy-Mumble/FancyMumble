...
import { useUserAvatar, useUserComment, useChannelDescription } from "@core/lazyBlobs";
  ...
  return (
    <>
      ...
      >
        ...
        {dmUnread > 0 && (
          <span
            className={styles.dmUnreadBadge}
            title={`${dmUnread} unread direct message${dmUnread === 1 ? "" : "s"}`}
          >
