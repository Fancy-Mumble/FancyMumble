...
export default function EmojiPicker({ anchorX, anchorY, onSelect, onClose }: EmojiPickerProps) {
        ...
        <div ref={gridRef} className={styles.emojiGrid}>
          ...
          {filteredCategories.map((cat) => (
            <div key={cat.id} data-cat={cat.id}>
              <p className={cat.id === "server" ? styles.serverLabel : styles.categoryLabel}>{cat.label}</p>
              <div className={styles.emojiRow}>
                {cat.emojis.map((emoji, i) => {
                  ...
                  return (
                    ...
                    >
                      {isImage ? <img src={emoji} alt="" className={styles.emojiImage} /> : emoji}
                    </button>
                  );
                })}
              </div>
