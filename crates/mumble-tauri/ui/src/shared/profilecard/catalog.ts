/**
 * The cosmetic catalogues a profile card resolves ids against.
 *
 * Ids are what travels in the stored `FancyProfile`; the CSS behind them lives
 * here, so a card painted by the client and one painted by the channel viewer
 * resolve "gold" or "rainbow" to the same pixels.
 */
