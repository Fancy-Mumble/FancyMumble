...
export enum TauriEvent {
  ...
  FancyForumFetchResponse = "fancy-forum-fetch-response",
  FancyForumPost = "fancy-forum-post",
  FancyPoll = "fancy-poll",
  FancyPollVote = "fancy-poll-vote",
  FancyScheduledMessageAck = "fancy-scheduled-message-ack",
  FancyScheduledMessageList = "fancy-scheduled-message-list",
