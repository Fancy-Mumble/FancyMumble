  ...
  return createPortal(
    <div className={styles.overlay} onMouseDown={handleOverlayClick}>
      <div className={styles.dialog} role="dialog" aria-modal="true">
        <h3 className={styles.title}>Move all users from&nbsp;<em>{sourceChannel.name}</em></h3>
        <p className={styles.body}>Select the destination channel:</p>
        <Autocomplete
          options={options}
          value={selected}
          onChange={setSelected}
          placeholder="Search channels..."
          noOptionsText="No matching channels"
