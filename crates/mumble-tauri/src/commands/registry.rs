...
pub(crate) fn register(builder: tauri::Builder<tauri::Wry>) -> tauri::Builder<tauri::Wry> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        super::invites::invite_support,
        super::invites::invite_create,
        super::invites::invite_list,
        super::invites::invite_revoke,
        super::invites::take_pending_deep_link,
        super::messaging::send_reaction,
        super::messaging::pin_message,
        super::messaging::delete_pchat_messages,
        super::messaging::forget_local_messages,
        ...
        super::audio::whisper_start,
        super::audio::whisper_end,
        super::audio::get_whisper_active,
        super::audio::whisper_register,
        super::audio::get_whisper_denials,
        ...
        super::voice_message::start_voice_message,
        super::voice_message::finish_voice_message,
        super::voice_message::cancel_voice_message,
        super::voice_message::discard_voice_clip,
        super::voice_message::request_voice_support,
        ...
        super::canon_emotes::canon_emotes,
        super::canon_emotes::canon_emote_add,
        super::canon_emotes::canon_emote_remove,
        super::records::account_record_get,
        super::records::account_record_put,
        super::records::account_record_remove,
        super::records::account_record_list,
        super::records::account_records_available,
        ...
        // -- external links --------------------------------------------
        super::browser::can_open_url_private,
        super::browser::open_url_private,
